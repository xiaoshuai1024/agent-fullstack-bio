...
- 加载并遵循 [.agents/skills/test-driven-development/SKILL.md](mdc:.agents/skills/test-driven-development/SKILL.md) 与 [docs/superpowers/AGENT_WORKFLOW_CONSTRAINTS.md](mdc:docs/superpowers/AGENT_WORKFLOW_CONSTRAINTS.md) **§2 严格 TDD**（红 → 绿 → 重构）。
